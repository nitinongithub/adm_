        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600">
        	<tr>
            	<td colspan="2" height="90">
                	<table border="0" cellpadding="0" cellspacing="0" width="600">
                    	<tr>
                        	<td align="left" width="90"><img src="image/aiLogo_.jpg" width="90" /></td>
        	...
        	<tr>
            	<td align="center" class="tdStyle1" colspan="2" height="25">Fee Receipt</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="bottom" align="right" width="50%">
						...
						if(mysql_num_rows($fresult) >0){
							...
							$qry_fee_detail = "SELECT * from fee_detail where feeID='" . $reciptno . "'";
							$reult_fee_detail = mysql_query($qry_fee_detail) or die(mysql_error());
						...
						<table border="0" cellpadding="0" cellspacing="0"  class="txtCntn" width="250">
                            ...
                            <tr>
                             ...
                             <?php if(mysql_num_rows($reult_fee_detail) > 0){?>
								<?php $rwfd = mysql_fetch_array($reult_fee_detail); ?>
								
								<tr>
	                                <td align="left">Academics Fee</b></td>
	                                <td align="left">Rs. <?PHP echo $rwfd['ACADEMIC'];?></td>
	                            </tr>
	                            
	                            <tr>
	                                <td align="left">University Fee</b></td>
	                                <td align="left">Rs. <?PHP echo $rwfd['UNIVERSITY'];?></td>
	                            </tr>
		                            
								<?php if($rwfd['CHK_CTPD'] == 'FALSE'){?>
									<tr>
		                                <td align="left">*CTPD Fee</b></td>
		                                <td align="left">Rs. <?PHP echo $rwfd['CTPD_FEE'];?></td>
		                            </tr>
								<?php }?>
								
								<?php if($rwfd['CHK_HOSTEL'] == 'FALSE'){?>
									<tr>
		                                <td align="left">*Hostel Fee</b></td>
		                                <td align="left">Rs. <?PHP echo $rwfd['HOSTEL_FEE'];?></td>
		                            </tr>
								<?php }?>
								
								<?php if($rwfd['CHK_SKILL_CERT'] == 'FALSE'){?>
									<tr>
		                                <td align="left">*Skill Certification Fee</b></td>
		                                <td align="left">Rs. <?PHP echo $rwfd['SKILL_CERTIFICATION_FEE'];?></td>
		                            </tr>
								<?php }?>
							...
							<tr>
                             ...
                             <tr>
                                <td align="left"><b>Total Amount Received</b></td>
                                <td align="left"><b>Rs. <?PHP echo $row['Amount'];?> /-</b></td>
                              </tr>
                              <tr>
                              	<td colspan="2" height="1"></td>
                              </tr>
            ...
            <tr>
                <td colspan="2" height="5" class="tdStyle2"></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="2" align="left" valign="middle" height="20">
                	<table border="0" cellpadding="0" cellspacing="0" width="600">
                    	...
                    	<tr>
                        	<td class="addr" valign="bottom" style="font-size:10px; font-family:Arial">
                            *Optional fee is not compulsory for student. Those student enrolled for additional
                            facilities beyond curriculum are required to submit the same.
                            </td>
                        </tr>
                    </table>
                </td>
