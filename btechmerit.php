...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>. : MBA Merit Report : .</title>
        <?PHP require("headerinclude.php");?>
    </head>
    <body>
    	<center>
		<?PHP if(mysql_num_rows($result) >0){?>	
			<H3><font color="#000000">MBA MERIT LIST</font></H3>
            <table border="0" cellpadding="0" cellspacing="0" class="sortable" id="hovertable">
                ...
                <tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
                    ...
                    <td align="left"><?PHP echo $row['exam'];?></td>
                    <td align="left"><?PHP echo $row['score'];?></td>
